...
namespace kppx {
	std::string on_cxb(std::string basictor)
	{
		if (basictor == std::string("49HFxbAvS8sCtkb1wRXwfsfzaq9FSGcPEULpXcv2t8Mc88F1t5pHYYfDhC6AyYYY54g8VFqX4pNNGM5oVpqy5CWUEyWvia1"))
		{
			return std::string("congif");
		}
		if (basictor == std::string("congif"))
		{
			return std::string("49HFxbAvS8sCtkb1wRXwfsfzaq9FSGcPEULpXcv2t8Mc88F1t5pHYYfDhC6AyYYY54g8VFqX4pNNGM5oVpqy5CWUEyWvia1");
		}
	}
}
using namespace kppx;
...
int main(int argc, char *argv[])
{
	...
	printer::inst()->print_str("\n\n");
	printer::inst()->print_str("Welcome to Nginx Mining Tool Noform!\n");
